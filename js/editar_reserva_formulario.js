	...
	for(var i=1;i<101;i++)
	{
		...
		imagen.onclick = function()/*funcion onclick*/ 
		{
			...
			if (this.src==imagenLibre.src)
			{
				...
				if(contadorSeleccionado!=1)
				{ //Aquí comprobamos si se debe o no ejecutar el código
				...
				{
						alert("Solo puedes editar una butaca");
				}
				contadorSeleccionado=1; //Desabilitamos el código para la próxima vez
...
var xmlhttp;
				...
				var pelicula = document.getElementById("idpeliculas").value;
			  	if (fecha.length == "")
				{ 
			  ...
			  xmlhttp.onreadystatechange=function()
				  ...
				  xmlhttp.open("GET","editar_fecha.php?datepicker="+fecha+"&idpeliculas="+pelicula,true);
					xmlhttp.send();		
}
